...
@Service
public class ResetUserTokenServiceImpl implements ResetUserTokenService {
    ResetUserTokenRepository resetUserTokenRepository;
    @Autowired
    public ResetUserTokenServiceImpl(ResetUserTokenRepository resetUserTokenRepository) {
